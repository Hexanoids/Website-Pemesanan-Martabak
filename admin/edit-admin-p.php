          ...
          <div class="g-table-admin">
            <div class="card">
              ...
              <?php
		        ...
		        $data = mysqli_query($conn,"select * from admin_pemesanan where id_admin_p='$id_admin_p'");
		        while($d = mysqli_fetch_array($data)){
	            ?>

              <form method="post" action="edit-action-admin-p.php" >
              <input type="hidden" name="id_admin_p" class="placeholder" value="<?php echo $id_admin_p; ?>">
