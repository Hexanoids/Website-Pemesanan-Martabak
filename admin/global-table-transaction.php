...
?>
    ...
    <body>
      ...
      <?php
        ...
        <section class="main">
          <div class="main-top">
            <h1>TABLE USER PENDING TRANSACTION</h1>
          </div>
        ...
        <table class="admin-table">
            ...
            <tbody>
                <?php 
                    ...
                    include '../conn.php';
                    $data = mysqli_query($conn, "select *FROM `transaction`
                    INNER JOIN `menu_martabak` ON menu_martabak.id_menu=`transaction`.id_menu 
                    INNER JOIN `user` ON `user`.id_user=`transaction`.id_user");
