    ...
    <body>
      ...
      <?php
        ...
        <section class="main">
          ...
          <section class="menu-content">
            ...
            <form action="tambah_aksi_TBPR_keranjang.php?id_menu=<?php echo $d['id_menu']; ?>" method="post">
            <div class="detail-card">
                <img src="../asset/<?php echo $d['img_menu']; ?>" name="img_menu" alt="">
                <div class="detail-card-content">
                     <h2 name="name_menu"><?php echo $d['name_menu']; ?></h2>
                     <p>Pilih Maksimal 16 Topping</p>
                     <div class="checkbox">
      ...
      <script>
        function ckChange(ckType){
            ...
            if (checked.checked && checkedCheckboxes.length > 16) {
