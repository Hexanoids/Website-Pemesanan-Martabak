...
?>
    ...
    <body>
      ...
      <?php
        ...
        ?>
          <a href="final-print.php?tanggal_awal=<?php echo $tanggal_awal; ?>&tanggal_akhir=<?php echo $tanggal_akhir; ?>" style="color:#db0001"><i class="fa fa-download" style="font-size:20px" >Print</i></a>
              </div>
