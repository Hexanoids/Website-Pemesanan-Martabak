                ...
                <?php
                    include 'conn.php';
                    $no = 1;
				    $data = mysqli_query($conn,"select * FROM menu_martabak where id_category=17 and no_varian='KCP1' AND stok='Tersedia';");
              ...
              $price=$d['price'];
                ...
                <?php
                    include 'conn.php';
                    $no = 1;
				    $data = mysqli_query($conn,"select * FROM menu_martabak where id_category=17 and no_varian='KCP2' AND stok='Tersedia';");
				    while($d = mysqli_fetch_array($data)){
              $price=$d['price'];
                ?>
          ...
          <?php
                    include 'conn.php';
                    $no = 1;
				    $data = mysqli_query($conn,"select * FROM menu_martabak where id_category=17 and no_varian='KCP3' AND stok='Tersedia';");
				    while($d = mysqli_fetch_array($data)){
              $price=$d['price'];
                ?>
        ...
        <?php
                    include 'conn.php';
                    $no = 1;
				    $data = mysqli_query($conn,"select * FROM menu_martabak where id_category=17 and no_varian='KP' AND stok='Tersedia';");
				    while($d = mysqli_fetch_array($data)){
              $price=$d['price'];
                ?>
        ...
        <?php
                    include 'conn.php';
                    $no = 1;
				    $data = mysqli_query($conn,"select * FROM menu_martabak where id_category=17 AND stok='Tidak Tersedia';");
				    while($d = mysqli_fetch_array($data)){
              $price=$d['price'];
                ?>
