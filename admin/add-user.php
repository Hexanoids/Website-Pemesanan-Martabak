        ...
        <section class="main">
          ...
          <div class="g-table-admin">
            <div class="card">
              ...
              <form method="post" action="add-action-user.php" >
              <table class="add-form">
                <tr>
                  <td><span>Full Name</span></td>
                  <td>
                    <div class="toogle">
                      <input type="text" name="full_name" class="placeholder">
                    </div>
                  </td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td>
                    <div class="toogle">
                      <input type="text" name="phone_number" class="placeholder" >
                    </div>
                  </td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td>
                    <div class="toogle">
                      <input type="text" name="level" class="placeholder" >
                    </div>
                  </td>
                </tr>
