    ...
    <body>
      ...
      <?php
        ...
        <section class="main">
          ...
          <section class="menu-content">
            ...
            <form action="tambah_aksi_TBK_keranjang.php?id_menu=<?php echo $d['id_menu']; ?>" method="post">
            <div class="detail-card">
                <img src="../asset/<?php echo $d['img_menu']; ?>" name="img_menu" alt="">
                <div class="detail-card-content">
                     <h2 name="name_menu"><?php echo $d['name_menu']; ?></h2>
                     <p>Pilih Maksimal 8 Topping</p>
                     <div class="checkbox">
                     <div class="varian-box">
                      <?php
		                    include '../conn.php';
		                    $datav1 = mysqli_query($conn,"select * from varian_rasa where id_varian='17'");
                      ...
                      <?php
		                    include '../conn.php';
		                    $datav2 = mysqli_query($conn,"select * from varian_rasa where id_varian='18'");
                      ...
                      <?php
		                    include '../conn.php';
		                    $datav3 = mysqli_query($conn,"select * from varian_rasa where id_varian='19'");
                      ...
                      <?php
		                    include '../conn.php';
		                    $datav4 = mysqli_query($conn,"select * from varian_rasa where id_varian='20'");
                      ...
                      <?php
		                    include '../conn.php';
		                    $datav5 = mysqli_query($conn,"select * from varian_rasa where id_varian='21'");
                      ...
                      <?php
		                    include '../conn.php';
		                    $datav6 = mysqli_query($conn,"select * from varian_rasa where id_varian='22'");
                      ...
                      <?php
		                    include '../conn.php';
		                    $datav7 = mysqli_query($conn,"select * from varian_rasa where id_varian='23'");
                      ...
                      <?php
		                    include '../conn.php';
		                    $datav8 = mysqli_query($conn,"select * from varian_rasa where id_varian='24'");
                      ...
                      <?php
		                    include '../conn.php';
		                    $datav9 = mysqli_query($conn,"select * from varian_rasa where id_varian='25'");
                      ...
                      <?php
		                    include '../conn.php';
		                    $datav10 = mysqli_query($conn,"select * from varian_rasa where id_varian='26'");
                      ...
                      <?php
		                    include '../conn.php';
		                    $datav11 = mysqli_query($conn,"select * from varian_rasa where id_varian='27'");
                      ...
                      <?php
		                    include '../conn.php';
		                    $datav12 = mysqli_query($conn,"select * from varian_rasa where id_varian='28'");
                      ...
                      <?php
		                    include '../conn.php';
		                    $datav13 = mysqli_query($conn,"select * from varian_rasa where id_varian='29'");
                      ...
                      <?php
		                    include '../conn.php';
		                    $datav14 = mysqli_query($conn,"select * from varian_rasa where id_varian='30'");
                      ...
                      <?php
		                    include '../conn.php';
		                    $datav15 = mysqli_query($conn,"select * from varian_rasa where id_varian='31'");
                      ...
                      <?php
		                    include '../conn.php';
		                    $datav16 = mysqli_query($conn,"select * from varian_rasa where id_varian='32'");
      ...
      <script>
        function ckChange(ckType){
            ...
            if (checked.checked && checkedCheckboxes.length > 8) {
