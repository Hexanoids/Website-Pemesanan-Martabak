    ...
    <body>
      ...
      <?php
        ...
        <div class="main-top">
            ...
            <a href="print-laporan-pemesanan.php"><i class="fa fa-print" style="font-size:24px"></i></a>
          </div>
                    ...
                    while($d = mysqli_fetch_array($data)){
                      $price=$d['total_price'];
                        ...
                        <tr>
                            ...
                            <th align="center">
                                <div class="btn-table">
                                    <a href="pemesanan-edit-user-order.php?id_order=<?php echo $d['id_order']; ?>"><button class="">EDIT</button></a>
                                    <a href="pemesanan-detail-user-order.php?id_order=<?php echo $d['id_order']; ?>"><button class="">DETAIL</button></a>
                                </div>
                            </th>
