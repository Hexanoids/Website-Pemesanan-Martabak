                ...
                <?php
                    include 'conn.php';
                    $no = 1;
				    $data = mysqli_query($conn,"select * FROM menu_martabak where id_category=2 and stok='Tersedia';");
              ...
              $price=$d['price'];
                ?>
                    ...
                    <ul class="cards">   
                        <li>
                          <a href="./detail-menu/detail-martabak-telur-bebek.php?id_menu=<?php echo $d['id_menu']; ?>" class="card">
                ...
                <?php
                    include 'conn.php';
                    $no = 1;
				    $data = mysqli_query($conn,"select * FROM menu_martabak where id_category=2 and stok='Tidak Tersedia';");
				    while($d = mysqli_fetch_array($data)){
              $price=$d['price'];
                ?>
